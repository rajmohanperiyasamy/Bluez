"""
Django settings for bluez project.
...
EMAIL_HOST_USER = 'chandruit15@gmail.com'
EMAIL_HOST_PASSWORD = 'computerp'
DEFAULT_FROM_EMAIL = ''
...
ROOT_URLCONF = 'bluez.urls'

WSGI_APPLICATION = 'bluez.wsgi.application'
